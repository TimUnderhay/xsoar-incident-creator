# Create a container: docker create -p 4002:4002 --name demisto-incident-importer demisto-incident-importer:latest
# Start the conatiner: docker start demisto-incident-importer
# Stop the container: docker stop demisto-incident-importer
# Run a temporary container: docker run -p 4002:4002 -ti --rm demisto-incident-importer:latest
